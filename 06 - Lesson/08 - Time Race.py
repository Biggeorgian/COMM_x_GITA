...
if player1 < player2:
    ...
    print(f"გამარჯვებულია პირველი მორბენალი. ️ის ფინიშამდე მივიდა {(player1 - start_time).seconds} წამში")
elif player2 < player1:
    print(f"\n{player2.strftime("%H:%M:%S")} . . . . 🏃‍➡️ . . 🏁 🏃‍♂️‍➡️ 🥇")
    print(f"გამარჯვებულია მეორე მორბენალი. ის ფინიშამდე მივიდა {(player2 - start_time).seconds} წამში")
else:
